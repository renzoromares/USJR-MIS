...
def CashAdvance(request,id):
    ...
    if(request.method == "POST"):
        ...
        cash_advance.save()
        memo_cash_advance = Memo_Routing(Level= "1",Id_Number = employeeID, Type_Request = 'Cash Advance', Date_Faculty_Submitted = datetime.today(), FormID = formPK, Status = 'Pending')
